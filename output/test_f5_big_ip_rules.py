    ...
    class TestF5_big_ipRules(unittest.TestCase):
            ...
            log = '''May  5 04:26:19 hostname type process[20175]: 01010343:0: Syncookie SW mode activated, server = 1.1.1.1:4000'''
            response = send_log(log)
            ...
            self.assertEqual(response.alert_level, 13)

            def test_Stopped_throttling_traffic(self) -> None:
            log = '''May  5 04:26:19 hostname type process[20175]: 011e0001:0: Limiting componentName from 40 to 40 packets/sec for traffic-group componentName'''
            response = send_log(log)
            ...
            log = '''May  5 04:26:19 hostname type process[20175]: 01010038:0: Syncookie counter 40 exceeded vip threshold %u for virtual = 1.1.1.1:4000'''
            response = send_log(log)
            ...
            log = '''May  5 04:26:19 hostname type process[20175]: 01010240:0: Syncookie HW mode activated, server = 1.1.1.1:4000, HSB modId = 40'''
            response = send_log(log)
            ...
            log = '''May  5 04:26:19 hostname type process[20175]: 01010329:0: BDoS: (TMM) Signature componentName: threshold_mode=componentName detection=%u mitigation_curr=%llu'''
            response = send_log(log)
            ...
            log = '''May  5 04:26:19 hostname type process[20175]: 01010302:0: BDoS: (TMM) componentName signature (componentName) for context componentName at idx %u (detection=%u mitigation=%u state=componentName transient=componentName retired=componentName).'''
            response = send_log(log)
            ...
            self.assertEqual(response.alert_level, 11)

            def test_Number_of_allowed_new_connections_per_second_for_pool_member_has_been_exceeded(self) -> None:
            log = '''May  5 04:26:19 hostname type process[20175]: 01010250:0: Pool member %A:%u exceeded configured rate limit.'''
            response = send_log(log)
            ...
            log = '''May  5 04:26:19 hostname type process[20175]: 01010241:0: Syncookie HW mode exited, server = 1.1.1.1:4000, HSB modId = 40 from componentName.'''
            response = send_log(log)
            ...
            log = '''May  5 04:26:19 hostname type process[20175]: 01010056:0: Syncookie counter 40 exceeded vip threshold %u for virtual = componentName'''
            response = send_log(log)
            ...
            log = '''May  5 04:26:19 hostname type process[20175]: 01010344:0: Syncookie SW mode exited, server = 1.1.1.1:4000'''
            response = send_log(log)
            ...
            log = '''May  5 04:26:19 hostname type process[20175]: 01071bee:0: SSLv2 is no longer supported and has been removed. The 'sslv2' keyword in the cipher string has been ignored.'''
            response = send_log(log)
            ...
            log = '''May  5 04:26:19 hostname type process[20175]: 01070822:0: "Access Denied: componentName"'''
            response = send_log(log)
            ...
            log = '''May  5 04:26:19 hostname type process[20175]: 01071bd1:0: Inbound CMI connection from IP (componentName) denied because it came from VLAN (componentName), not from expected VLAN (componentName).'''
            response = send_log(log)
            ...
            log = '''May  5 04:26:19 hostname type process[20175]: 01860017:0: MR_SIP: Too many media sessions 40 / 40. Error Code 40'''
            response = send_log(log)
            ...
            log = '''May  5 04:26:19 hostname type process[20175]: 01010020:0: MCP Connection componentName, exiting'''
            response = send_log(log)
            ...
            log = '''May  5 04:26:19 hostname type process[20175]: 01071d0b:0: adm: componentName'''
            response = send_log(log)
            ...
            log = '''May  5 04:26:19 hostname type process[20175]: 012a0002:0: "LIBHAL reporting critical conditions"'''
            response = send_log(log)
            ...
            log = '''May  5 04:26:19 hostname type process[20175]: 012a0003:0: LIBHAL reporting error conditions'''
            response = send_log(log)
            ...
            log = '''May  5 04:26:19 hostname type process[20175]: 012a0013:0: Blade 40 hardware sensor critical alarm: componentName'''
            response = send_log(log)
            ...
            def test_AOM_has_indicated_that_a_temperature_sensor_has_crossed_a_'critical'_level_threshold(self) -> None:
            log = '''May  5 04:26:19 hostname type process[20175]: 012a0031:0: componentName'''
            response = send_log(log)
            ...
            def test_AOM_has_indicated_that_a_fan_sensor_has_crossed_a_'critical'_threshold(self) -> None:
            log = '''May  5 04:26:19 hostname type process[20175]: 012a0037:0: componentName'''
            response = send_log(log)
            ...
            def test_AOM_has_indicated_that_a_power_sensor_has_crossed_a_'critical'_threshold(self) -> None:
            log = '''May  5 04:26:19 hostname type process[20175]: 012a0043:0: componentName'''
            response = send_log(log)
            ...
            log = '''May  5 04:26:19 hostname type process[20175]: 012c0011:0: BCM56XXD SDK error'''
            response = send_log(log)
            ...
            log = '''May  5 04:26:19 hostname type process[20175]: 01340003:0: Cluster error: componentName'''
            response = send_log(log)
            ...
            log = '''May  5 04:26:19 hostname type process[20175]: 01510003:0: componentName'''
            response = send_log(log)
            ...
            log = '''May  5 04:26:19 hostname type process[20175]: 01550004:0: Critical:'''
            response = send_log(log)
            ...
            log = '''May  5 04:26:19 hostname type process[20175]: 01550005:0: Critical:'''
            response = send_log(log)
            ...
            log = '''May  5 04:26:19 hostname type process[20175]: 01550006:0: Critical:'''
            response = send_log(log)
            ...
            log = '''May  5 04:26:19 hostname type process[20175]: 01940007:0: "Failed to allocate the errdefs tmconf handle!"'''
            response = send_log(log)
            ...
            def test_Critical_The_file_PLATFORM_isn't_found_and_licensing_logic_cannot_determine_the_platform_type(self) -> None:
            log = '''May  5 04:26:19 hostname type process[20175]: 01a70028:0: The platform was not found in componentName.'''
            response = send_log(log)
            ...
            log = '''May  5 04:26:19 hostname type process[20175]: 01071d94:0: Bot Defense Profile (componentName) Micro Service (componentName): Missing required field (componentName).'''
            response = send_log(log)
            ...
            log = '''May  5 04:26:19 hostname type process[20175]: 01071d9e:0: Bot defense anomaly componentName not found.'''
            response = send_log(log)
            ...
            log = '''May  5 04:26:19 hostname type process[20175]: 013e0002:0: Tcpdump stopping on %la:%u from %la:%u'''
            response = send_log(log)
            ...
            log = '''May  5 04:26:19 hostname type process[20175]: 013e0005:0: Tcpdump starting remote to %A from %A'''
            response = send_log(log)
            ...
            log = '''May  4 13:42:12 some.host.name crit server_handler.pl[24895]: 01310027:2: ASM subsystem error (asm_config_server.pl,(eval)): Couldn't pass call to async process - ignoring'''
            response = send_log(log)
            ...
            log = '''May  5 04:26:19 hostname info process[20175]: 01011111:0: MCP Connection %s, exiting'''
            response = send_log(log)
            ...
            log = '''May  5 04:26:19 hostname notice process[20175]: 01011111:0: MCP Connection %s, exiting'''
            response = send_log(log)
            ...
            log = '''May  5 04:26:19 hostname warning process[20175]: 01011111:0: MCP Connection %s, exiting'''
            response = send_log(log)
            ...
            log = '''May  5 04:26:19 hostname alert process[20175]: 01011111:0: MCP Connection %s, exiting'''
            response = send_log(log)
            ...
            log = '''May  5 04:26:19 hostname crit process[20175]: 01011111:0: MCP Connection %s, exiting'''
            response = send_log(log)
