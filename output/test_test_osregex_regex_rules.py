...
'''
    ...
    def test_osregex_test_osregex_3_action(self) -> None:
        log = r'''
Dec 19 17:20:08 ubuntu test_osregex_3[12345]:test_action action_example_1*
'''
        response = send_log(log)
    ...
    def test_osregex_test_osregex_3_action_n(self) -> None:
        log = r'''
Dec 19 17:20:08 ubuntu test_osregex_3[12345]:test_action action_example_9*
'''
        response = send_log(log)
    ...
    def test_osregex_test_osregex_4_extra_data(self) -> None:
        log = r'''
Dec 19 17:20:08 ubuntu test_osregex_4[12345]:test_extra_data extra_data_example_1*
'''
        response = send_log(log)
    ...
    def test_osregex_test_osregex_4_extra_data_n(self) -> None:
        log = r'''
Dec 19 17:20:08 ubuntu test_osregex_4[12345]:test_extra_data extra_data_example_9*
'''
        response = send_log(log)
    ...
    def test_osregex_test_osregex_5_id(self) -> None:
        log = r'''
Dec 19 17:20:08 ubuntu test_osregex_5[12345]:test_id id_example_1*
'''
        response = send_log(log)
    ...
    def test_osregex_test_osregex_5_id_n(self) -> None:
        log = r'''
Dec 19 17:20:08 ubuntu test_osregex_5[12345]:test_id id_example_9*
'''
        response = send_log(log)
    ...
    def test_osregex_test_osregex_6_location(self) -> None:
        log = r'''
Dec 19 17:20:08 ubuntu test_osregex_6[12345]:test_location
'''
        response = send_log(log)
    ...
    def test_osregex_test_osregex_6_hostname(self) -> None:
        log = r'''
Dec 19 17:20:08 ubuntu test_osregex_6[12345]:test_hostname
'''
        response = send_log(log)
    ...
    def test_osregex_test_osregex_6_program_name(self) -> None:
        log = r'''
Dec 19 17:20:08 ubuntu test_osregex_6[12345]:test_program_name
'''
        response = send_log(log)
    ...
    def test_osregex_test_osregex_7_match(self) -> None:
        log = r'''
Dec 19 17:20:08 ubuntu test_osregex_7[12345]:test_match match_example_1*
'''
        response = send_log(log)
    ...
    def test_osregex_test_osregex_7_match_n(self) -> None:
        log = r'''
Dec 19 17:20:08 ubuntu test_osregex_7[12345]:test_match match_example_9*
'''
        response = send_log(log)
    ...
    def test_osregex_test_osregex_8_protocol(self) -> None:
        log = r'''
Dec 19 17:20:08 ubuntu test_osregex_8[12345]:test_protocol protocol_example_1*
'''
        response = send_log(log)
    ...
    def test_osregex_test_osregex_8_protocol_n(self) -> None:
        log = r'''
Dec 19 17:20:08 ubuntu test_osregex_8[12345]:test_protocol protocol_example_9*
'''
        response = send_log(log)
    ...
    def test_osregex_test_osregex_9_user(self) -> None:
        log = r'''
Dec 19 17:20:08 ubuntu test_osregex_9[12345]:test_user user_example_1*
'''
        response = send_log(log)
    ...
    def test_osregex_test_osregex_9_user_n(self) -> None:
        log = r'''
Dec 19 17:20:08 ubuntu test_osregex_9[12345]:test_user user_example_9*
'''
        response = send_log(log)
    ...
    def test_osregex_test_osregex_10_url(self) -> None:
        log = r'''
Dec 19 17:20:08 ubuntu test_osregex_10[12345]:test_url url_example_1*
'''
        response = send_log(log)
    ...
    def test_osregex_test_osregex_10_url_n(self) -> None:
        log = r'''
Dec 19 17:20:08 ubuntu test_osregex_10[12345]:test_url url_example_9*
'''
        response = send_log(log)
    ...
    def test_osregex_test_osregex_11_srcport(self) -> None:
        log = r'''
Dec 19 17:20:08 ubuntu test_osregex_11[12345]:test_srcport srcport_example_1*
'''
        response = send_log(log)
    ...
    def test_osregex_test_osregex_11_srcport_n(self) -> None:
        log = r'''
Dec 19 17:20:08 ubuntu test_osregex_11[12345]:test_srcport srcport_example_9*
'''
        response = send_log(log)
    ...
    def test_osregex_test_osregex_12_dstport(self) -> None:
        log = r'''
Dec 19 17:20:08 ubuntu test_osregex_12[12345]:test_dstport dstport_example_1*
'''
        response = send_log(log)
    ...
    def test_osregex_test_osregex_12_dstport_n(self) -> None:
        log = r'''
Dec 19 17:20:08 ubuntu test_osregex_12[12345]:test_dstport dstport_example_9*
'''
        response = send_log(log)
    ...
    def test_osregex_test_osregex_13_status(self) -> None:
        log = r'''
Dec 19 17:20:08 ubuntu test_osregex_13[12345]:test_status status_example_1*
'''
        response = send_log(log)
    ...
    def test_osregex_test_osregex_13_status_n(self) -> None:
        log = r'''
Dec 19 17:20:08 ubuntu test_osregex_13[12345]:test_status status_example_9*
'''
        response = send_log(log)
    ...
    def test_osregex_test_osregex_14_system_name(self) -> None:
        log = r'''
Dec 19 17:20:08 ubuntu test_osregex_14[12345]:test_system_name system_name_example_1*
'''
        response = send_log(log)
    ...
    def test_osregex_test_osregex_14_system_name_n(self) -> None:
        log = r'''
Dec 19 17:20:08 ubuntu test_osregex_14[12345]:test_system_name system_name_example_9*
'''
        response = send_log(log)
    ...
    def test_osregex_test_osregex_15_data(self) -> None:
        log = r'''
Dec 19 17:20:08 ubuntu test_osregex_15[12345]:test_data data_example_1*
'''
        response = send_log(log)
    ...
    def test_osregex_test_osregex_15_data_n(self) -> None:
        log = r'''
Dec 19 17:20:08 ubuntu test_osregex_15[12345]:test_data data_example_9*
'''
        response = send_log(log)
