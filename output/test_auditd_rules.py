...
'''
    ...
    def test_audit_passwd_was_used_to_lock_an_account(self) -> None:
        log = r'''
type=ACCT_LOCK msg=audit(1630937849.448:891): pid=4171 uid=0 auid=1000 ses=3 subj=unconfined_u:unconfined_r:passwd_t:s0-s0:c0.c1023 msg='op=locked-password id=1001 exe="/usr/bin/passwd" hos>
'''
        response = send_log(log)
    ...
    def test_audit_passwd_was_used_to_unlock_an_account(self) -> None:
        log = r'''
type=ACCT_UNLOCK msg=audit(1630937871.591:892): pid=4172 uid=0 auid=1000 ses=3 subj=unconfined_u:unconfined_r:passwd_t:s0-s0:c0.c1023 msg='op=unlocked-password id=1001 exe="/usr/bin/passwd">
'''
        response = send_log(log)
