...
class TestPixRules(unittest.TestCase):
    ...
    def test_pix1_2(self) -> None:
        log = r'''%PIX-3-710003: TCP access denied by ACL from 216.39.220.130/54065 to outside:62.192.113.98/ssh'''
        response = send_log(log)
    ...
    def test_pix1_3(self) -> None:
        log = r'''%PIX-3-106010: Deny inbound tcp src outside:213.98.79.233/2620 dst dmz:213.98.254.145/135'''
        response = send_log(log)
    ...
    def test_pix3_1(self) -> None:
        log = r'''%PIX-7-710002: UDP access permitted from 33.33.33.4/943 to inside:33.33.33.15/snmp'''
        response = send_log(log)
    ...
    def test_pix3_2(self) -> None:
        log = r'''%PIX-7-710005: UDP request discarded from <public IP of 525>/4500 to outside:192.168.69.137/4500'''
        response = send_log(log)
    ...
    def test_pix3_3(self) -> None:
        log = r'''%PIX-7-710002: TCP access permitted from 10.0.0.1/60749 to db:10.0.0.2/ssh'''
        response = send_log(log)
    ...
    def test_pix3_4(self) -> None:
        log = r'''%PIX-6-106015: Deny TCP (no connection) from 161.58.238.151/110 to a.b.c.d/3782 flags RST ACK'''
        response = send_log(log)
    ...
    def test_pix3_5(self) -> None:
        log = r'''%PIX-3-106011: Deny inbound (No xlate) udp src outside:192.168.2.1/137'''
        response = send_log(log)
    ...
    def test_pix3_6(self) -> None:
        log = r'''%PIX-3-106011: Deny inbound (No xlate) tcp src inside:10.100.7.43/80 dst'''
        response = send_log(log)
    ...
    def test_pix5(self) -> None:
        log = r'''%PIX-4-106023: Deny tcp src inside:111.11.11.1/2143 dst YYY:172.11.1.11/139 by access-group "inside_inbound"'''
        response = send_log(log)
    ...
    def test_pix6_1(self) -> None:
        log = r'''%PIX-2-106006: Deny inbound UDP from ***/20031 to ***/20031 on'''
        response = send_log(log)
    ...
    def test_pix6_2(self) -> None:
        log = r'''%PIX-2-106001: Inbound TCP connection denied from 165.139.46.7/3854 to 165.189.27.70/139 flags'''
        response = send_log(log)
    ...
    def test_pix8_1(self) -> None:
        log = r'''%PIX-6-305012: Teardown dynamic UDP translation from inside:1.1.1.1/12 to outside:1.2.1.2/11 duration 0:00:11.'''
        response = send_log(log)
