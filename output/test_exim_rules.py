...
class TestEximRules(unittest.TestCase):
    ...
    def test_exim_auth_failure_2(self) -> None:
        log = '''2017-01-24 05:22:29 dovecot_plain authenticator failed for (test) [::1]:39454: 535 Incorrect authentication data (set_id=test)'''
        response = send_log(log)
    ...
    def test_exim_connection(self) -> None:
        log = '''2017-01-24 03:09:46 SMTP connection from [10.101.1.10]:55010 (TCP/IP connection count = 1)'''
        response = send_log(log)
    ...
    def test_exim_connection_lost(self) -> None:
        log = '''2017-01-24 02:53:13 SMTP connection from (hydra) [10.101.1.10]:53682 lost'''
        response = send_log(log)
    ...
    def test_exim_syntax_protocol_error(self) -> None:
        log = '''2017-01-24 05:36:23 SMTP call from (000000) [::1]:39480 dropped: too many syntax or protocol errors (last command was "123")'''
        response = send_log(log)
    ...
    def test_exim_protocol_synchronization_error(self) -> None:
        log = '''2019-10-20 11:14:38 SMTP protocol synchronization error (input sent without waiting for greeting): rejected connection from H=[134.234.45.34] input="GET / HTTP/1.1\r\nHost: 24.255.212.213:98\r\nUser-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10.11; rv:47.0) Gecko/20100101 Firefox/47.0\r\nAccept: */*\r\n"'''
        response = send_log(log)
    ...
    def test_exim_unrouteable_address(self) -> None:
        log = '''2019-10-20 09:56:39 H=123-123-12-123.example.example.net [123.123.12.123] F=<example@example.com> rejected RCPT <example@exampley.com>: Unrouteable address'''
        response = send_log(log)
