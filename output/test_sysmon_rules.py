...
class TestSysmonRules(unittest.TestCase):
    ...
    def test_windows_event(self) -> None:
        log = '''2013 Oct 09 17:09:04 WinEvtLog: Application: INFORMATION(1): My Script: (no user): no domain: demo1.foo.example.com: test'''
        response = send_log(log)
    ...
    def test_sysmon_eventid_4(self) -> None:
        log = '''{"win":{"eventdata":{"schemaVersion":"4.70","utcTime":"2021-08-13 20:59:07.499","state":"Started","version":"13.22"},"system":{"eventID":"4","keywords":"0x8000000000000000","providerGuid":"{5770385f-c22a-43e0-bf4c-06f5698ffbd9}","level":"4","channel":"Microsoft-Windows-Sysmon/Operational","opcode":"0","message":"\"Sysmon service state changed:\r\nUtcTime: 2021-08-13 20:59:07.499\r\nState: Started\r\nVersion: 13.22\r\nSchemaVersion: 4.70\"","version":"3","systemTime":"2021-08-13T20:59:07.4999128Z","eventRecordID":"342247","threadID":"4260","computer":"hrmanager.ExchangeTest.com","task":"4","processID":"2668","severityValue":"INFORMATION","providerName":"Microsoft-Windows-Sysmon"}}}'''
        response = send_log(log)
