...
'''
    ...
    def test_cisco_asa_connection_limit_exceeded(self) -> None:
        log = r'''
%ASA-7-710004: TCP connection limit exceeded from 192.168.0.1/11 to outside:192.168.0.2/22 (current connections/connection limit = 11/10)
'''
        response = send_log(log)
    ...
    def test_cisco_asa_attack_in_progress_detected_1(self) -> None:
        log = r'''
%ASA-1-106022: Deny protocol connection spoof from 192.168.0.1 to 192.168.0.2 on interface interfacename.
'''
        response = send_log(log)
...
'''
    ...
    def test_cisco_asa_attack_in_progress_detected_4(self) -> None:
        log = r'''
%ASA-1-106021: Deny protocol reverse path check from 192.168.0.1 to 192.168.0.2 on interface interfacename
'''
        response = send_log(log)
    ...
    def test_cisco_asa_aaa_vpn_authentication_failed(self) -> None:
        log = r'''
%ASA-6-113005: AAA user authentication Rejected: reason = string: server = 174.143.32.22, User = user: user IP = 192.168.0.1
'''
        response = send_log(log)
    ...
    def test_cisco_asa_aaa_vpn_authentication_successful(self) -> None:
        log = r'''
%ASA-6-113004: AAA user example Successful: server = 174.243.13.65, User = user
'''
        response = send_log(log)
...
'''
    ...
    def test_cisco_asa_firewall_failover_pair_communication_problem_2(self) -> None:
        log = r'''
%ASA-1-105009: (Primary) Testing on interface interface_name Failed
'''
        response = send_log(log)
...
'''
    ...
    def test_cisco_asa_firewall_configuration_deleted(self) -> None:
        log = r'''
%ASA-5-111003: 192.168.0.1 Erase configuration
'''
        response = send_log(log)
    ...
    def test_cisco_asa_firewall_configuration_changed_1(self) -> None:
        log = r'''
%ASA-5-111005: 192.168.0.1 end configuration: OK
'''
        response = send_log(log)
    ...
    def test_cisco_asa_firewall_configuration_changed_2(self) -> None:
        log = r'''
%ASA-5-111004: 192.168.0.1 end configuration: FAILED
'''
        response = send_log(log)
    ...
    def test_cisco_asa_firewall_configuration_changed_3(self) -> None:
        log = r'''
%ASA-5-111002: Begin configuration: 192.168.0.1 reading from device
'''
        response = send_log(log)
    ...
    def test_cisco_asa_firewall_configuration_changed_4(self) -> None:
        log = r'''
%ASA-5-111007: Begin configuration: 192.168.0.1 reading from device.
'''
        response = send_log(log)
