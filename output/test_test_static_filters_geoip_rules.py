...
'''
    ...
    def test_same_fields_same_srcgeoip_4(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_same_filters[12345]:Test same_srcgeoip 'Srcuser' 'User' logged from 2.136.14.146:8 to 192.168.5.4:20 pro:ftp act:remove id:1 url:ossec dat:huzaw e_data:hwazu sta:rejected systemname:system1
'''
        response = send_log(log)
...
'''
    ...
    def test_different_fields_different_srcgeoip_7(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_different_filters[12345]:Test different_srcgeoip 'Srcuser' 'User' logged from 2.136.14.146:8 to 192.168.5.4:20 pro:ftp act:remove id:1 url:ossec dat:huzaw e_data:hwazu sta:rejected systemname:system1
'''
        response = send_log(log)
...
'''
    ...
    def test_same_fields_same_dstgeoip_4(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_same_filters[12345]:Test same_dstgeoip 'Srcuser' 'User' logged from 192.168.1.100:8 to 2.136.14.146:8 pro:ftp act:remove id:1 url:ossec dat:huzaw e_data:hwazu sta:rejected systemname:system1
'''
        response = send_log(log)
...
'''
    ...
    def test_different_fields_different_dstgeoip_1(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_different_filters[12345]:Test different_dstgeoip 'Srcuser' 'User' logged from 192.168.1.100:8 to 2.136.147.146:20 pro:ftp act:remove id:1 url:ossec dat:huzaw e_data:hwazu sta:rejected systemname:system1
'''
        response = send_log(log)
...
'''
    ...
    def test_different_fields_different_dstgeoip_7(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_different_filters[12345]:Test different_dstgeoip 'Srcuser' 'User' logged from 192.168.1.100:8 to 2.136.14.146:20 pro:ftp act:remove id:1 url:ossec dat:huzaw e_data:hwazu sta:rejected systemname:system1
'''
        response = send_log(log)
