...
class TestPandaPapsRules(unittest.TestCase):
    ...
    def test_panda_paps_medium_severity_event_detected(self) -> None:
        log = r'''LEEF:1.0|Panda Security|paps|02.47.00.0000|registrym|sev=5	devTime=2019-05-09 22:01:23.255825	devTimeFormat=yyyy-MM-dd HH:mm:ss.SSS	usrName=SYSTEM	domain=NT AUTHORITY	src=10.255.44.11	identSrc=10.255.44.11	identHostName=44_CCO_11	HostName=44_CCO_11	MUID=D877F2C4C4000A9BF39F1710CA787291	Op=ModifyExeKey	Hash=F6494E7C35B6514A3AD74E27435F3141	DriveType=Fixed	Path=PROGRAM_FILESX86|\LANDesk\LDClient\hips\LDSecSvc64.EXE	ValidSig=true	Company=LANDESK Software, Inc. and its affiliates.	Broken=false	ImageType=EXE 64	ExeType=Unknown	Prevalence=Low	PrevLastDay=Low	Cat=Goodware	MWName=	TargetPath=3|PROGRAM_FILESX86|\LANDesk\LDClient\LDdrives.exe'''
        response = send_log(log)
    ...
    def test_panda_paps_high_severity_event_detected(self) -> None:
        log = r'''LEEF:1.0|Panda Security|paps|02.47.00.0000|registrym|sev=7	devTime=2019-05-09 22:01:23.255825	devTimeFormat=yyyy-MM-dd HH:mm:ss.SSS	usrName=SYSTEM	domain=NT AUTHORITY	src=10.255.44.11	identSrc=10.255.44.11	identHostName=44_CCO_11	HostName=44_CCO_11	MUID=D877F2C4C4000A9BF39F1710CA787291	Op=ModifyExeKey	Hash=F6494E7C35B6514A3AD74E27435F3141	DriveType=Fixed	Path=PROGRAM_FILESX86|\LANDesk\LDClient\hips\LDSecSvc64.EXE	ValidSig=true	Company=LANDESK Software, Inc. and its affiliates.	Broken=true	ImageType=EXE 64	ExeType=Unknown	Prevalence=Low	PrevLastDay=Low	Cat=Goodware	MWName=	TargetPath=3|PROGRAM_FILESX86|\LANDesk\LDClient\LDdrives.exe'''
        response = send_log(log)
    ...
    def test_panda_paps_very_high_severity_event_detected(self) -> None:
        log = r'''LEEF:1.0|Panda Security|paps|02.47.00.0000|registrym|sev=9	devTime=2019-05-09 22:01:23.255825	devTimeFormat=yyyy-MM-dd HH:mm:ss.SSS	usrName=SYSTEM	domain=NT AUTHORITY	src=10.255.44.11	identSrc=10.255.44.11	identHostName=44_CCO_11	HostName=44_CCO_11	MUID=D877F2C4C4000A9BF39F1710CA787291	Op=ModifyExeKey	Hash=F6494E7C35B6514A3AD74E27435F3141	DriveType=Fixed	Path=PROGRAM_FILESX86|\LANDesk\LDClient\hips\LDSecSvc64.EXE	ValidSig=true	Company=LANDESK Software, Inc. and its affiliates.	Broken=true	ImageType=EXE 64	ExeType=Unknown	Prevalence=Low	PrevLastDay=Low	Cat=Goodware	MWName=	TargetPath=3|PROGRAM_FILESX86|\LANDesk\LDClient\LDdrives.exe'''
        response = send_log(log)
    ...
    def test_panda_paps_a_file_is_corrupted_or_defective(self) -> None:
        log = r'''LEEF:1.0|Panda Security|paps|02.47.00.0000|registrym|sev=1	devTime=2019-05-09 22:01:23.255825	devTimeFormat=yyyy-MM-dd HH:mm:ss.SSS	usrName=SYSTEM	domain=NT AUTHORITY	src=10.255.44.11	identSrc=10.255.44.11	identHostName=44_CCO_11	HostName=44_CCO_11	MUID=D877F2C4C4000A9BF39F1710CA787291	Op=ModifyExeKey	Hash=F6494E7C35B6514A3AD74E27435F3141	DriveType=Fixed	Path=PROGRAM_FILESX86|\LANDesk\LDClient\hips\LDSecSvc64.EXE	ValidSig=true	Company=LANDESK Software, Inc. and its affiliates.	Broken=true	ImageType=EXE 64	ExeType=Unknown	Prevalence=Low	PrevLastDay=Low	Cat=Goodware	MWName=	TargetPath=3|PROGRAM_FILESX86|\LANDesk\LDClient\LDdrives.exe'''
        response = send_log(log)
