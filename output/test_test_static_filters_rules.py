...
'''
    ...
    def test_same_fields_same_srcip_4(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_same_filters[12345]:Test same_srcip 'Srcuser' 'User' logged from 192.168.1.90:8 to 192.168.5.4:20 pro:ftp act:remove id:1 url:ossec dat:huzaw e_data:hwazu sta:rejected systemname:system1
'''
        response = send_log(log)
...
'''
    ...
    def test_same_fields_same_dstip_4(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_same_filters[12345]:Test same_dstip 'Srcuser' 'User' logged from 192.168.1.100:8 to 192.168.0.0:20 pro:ftp act:remove id:1 url:ossec dat:huzaw e_data:hwazu sta:rejected systemname:system1
'''
        response = send_log(log)
...
'''
    ...
    def test_same_fields_same_srcuser_1(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_same_filters[12345]:Test same_srcuser 'Admin' 'User' logged from 192.168.1.100:8 to 192.168.5.4:20 pro:ftp act:remove id:1 url:ossec dat:huzaw e_data:hwazu sta:rejected systemname:system1
'''
        response = send_log(log)
...
'''
    ...
    def test_same_fields_same_srcuser_4(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_same_filters[12345]:Test same_srcuser 'unknown' 'User' logged from 192.168.1.100:8 to 192.168.5.4:20 pro:ftp act:remove id:1 url:ossec dat:huzaw e_data:hwazu sta:rejected systemname:system1
'''
        response = send_log(log)
...
'''
    ...
    def test_same_fields_same_user_1(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_same_filters[12345]:Test same_user 'Srcuser' 'Admin' logged from 192.168.1.100:8 to 192.168.5.4:20 pro:ftp act:remove id:1 url:ossec dat:huzaw e_data:hwazu sta:rejected systemname:system1
'''
        response = send_log(log)
...
'''
    ...
    def test_same_fields_same_user_4(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_same_filters[12345]:Test same_user 'Srcuser' 'unknown' logged from 192.168.1.100:8 to 192.168.5.4:20 pro:ftp act:remove id:1 url:ossec dat:huzaw e_data:hwazu sta:rejected systemname:system1
'''
        response = send_log(log)
...
'''
    ...
    def test_same_fields_same_srcport_4(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_same_filters[12345]:Test same_srcport 'Srcuser' 'User' logged from 192.168.1.100:200 to 192.168.5.4:20 pro:ftp act:remove id:1 url:ossec dat:huzaw e_data:hwazu sta:rejected systemname:system1
'''
        response = send_log(log)
...
'''
    ...
    def test_same_fields_same_dstport_4(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_same_filters[12345]:Test same_dstport 'Srcuser' 'User' logged from 192.168.1.100:8 to 192.168.5.4:100 pro:ftp act:remove id:1 url:ossec dat:huzaw e_data:hwazu sta:rejected systemname:system1
'''
        response = send_log(log)
...
'''
    ...
    def test_same_fields_same_protocol_4(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_same_filters[12345]:Test same_protocol 'Srcuser' 'User' logged from 192.168.1.100:8 to 192.168.5.4:20 pro:ssh act:remove id:1 url:ossec dat:huzaw e_data:hwazu sta:rejected systemname:system1
'''
        response = send_log(log)
...
'''
    ...
    def test_same_fields_same_action_4(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_same_filters[12345]:Test same_action 'Srcuser' 'User' logged from 192.168.1.100:8 to 192.168.5.4:20 pro:ftp act:install id:1 url:ossec dat:huzaw e_data:hwazu sta:rejected systemname:system1
'''
        response = send_log(log)
...
'''
    ...
    def test_same_fields_same_id_4(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_same_filters[12345]:Test same_id 'Srcuser' 'User' logged from 192.168.1.100:8 to 192.168.5.4:20 pro:ftp act:remove id:2 url:ossec dat:huzaw e_data:hwazu sta:rejected systemname:system1
'''
        response = send_log(log)
...
'''
    ...
    def test_same_fields_same_url_4(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_same_filters[12345]:Test same_url 'Srcuser' 'User' logged from 192.168.1.100:8 to 192.168.5.4:20 pro:ftp act:remove id:1 url:wazuh dat:huzaw e_data:hwazu sta:rejected systemname:system1
'''
        response = send_log(log)
...
'''
    ...
    def test_same_fields_same_data_4(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_same_filters[12345]:Test same_data 'Srcuser' 'User' logged from 192.168.1.100:8 to 192.168.5.4:20 pro:ftp act:remove id:1 url:ossec dat:cesso e_data:hwazu sta:rejected systemname:system1
'''
        response = send_log(log)
...
'''
    ...
    def test_same_fields_same_extra_data_4(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_same_filters[12345]:Test same_extra_data 'Srcuser' 'User' logged from 192.168.1.100:8 to 192.168.5.4:20 pro:ftp act:remove id:1 url:ossec dat:huzaw e_data:cesso sta:rejected systemname:system1
'''
        response = send_log(log)
...
'''
    ...
    def test_same_fields_same_status_4(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_same_filters[12345]:Test same_status 'Srcuser' 'User' logged from 192.168.1.100:8 to 192.168.5.4:20 pro:ftp act:remove id:1 url:ossec dat:huzaw e_data:hwazu sta:accepted systemname:system1
'''
        response = send_log(log)
...
'''
    ...
    def test_same_fields_same_system_name_4(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_same_filters[12345]:Test same_system_name 'Srcuser' 'User' logged from 192.168.1.100:8 to 192.168.5.4:20 pro:ftp act:remove id:1 url:ossec dat:huzaw e_data:hwazu sta:rejected systemname:system100
'''
        response = send_log(log)
...
'''
    ...
    def test_different_fields_different_srcip_6(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_different_filters[12345]:Test different_srcip 'Srcuser' 'User' logged from 192.168.0.200:8 to 192.168.5.4:20 pro:ftp act:remove id:1 url:ossec dat:huzaw e_data:hwazu sta:rejected systemname:system1
'''
        response = send_log(log)
...
'''
    ...
    def test_different_fields_different_dstip_6(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_different_filters[12345]:Test different_dstip 'Srcuser' 'User' logged from 192.168.1.100:8 to 192.168.102.60:20 pro:ftp act:remove id:1 url:ossec dat:huzaw e_data:hwazu sta:rejected systemname:system1
'''
        response = send_log(log)
    ...
    def test_different_fields_different_srcuser_1(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_different_filters[12345]:Test different_srcuser 'Srcuser' 'User' logged from 192.168.1.100:8 to 192.168.5.4:20 pro:ftp act:remove id:1 url:ossec dat:huzaw e_data:hwazu sta:rejected systemname:system1
'''
        response = send_log(log)
...
'''
    ...
    def test_different_fields_different_srcuser_6(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_different_filters[12345]:Test different_srcuser 'Unknown' 'User' logged from 192.168.1.100:8 to 192.168.5.4:20 pro:ftp act:remove id:1 url:ossec dat:huzaw e_data:hwazu sta:rejected systemname:system1
'''
        response = send_log(log)
...
'''
    ...
    def test_different_fields_different_user_6(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_different_filters[12345]:Test different_user 'Srcuser' 'Unknown' logged from 192.168.1.100:8 to 192.168.5.4:20 pro:ftp act:remove id:1 url:ossec dat:huzaw e_data:hwazu sta:rejected systemname:system1
'''
        response = send_log(log)
...
'''
    ...
    def test_different_fields_different_src_port_6(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_different_filters[12345]:Test different_src_port 'Srcuser' 'User' logged from 192.168.1.100:100 to 192.168.5.4:20 pro:ftp act:remove id:1 url:ossec dat:huzaw e_data:hwazu sta:rejected systemname:system1
'''
        response = send_log(log)
...
'''
    ...
    def test_different_fields_different_dst_port_6(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_different_filters[12345]:Test different_dst_port 'Srcuser' 'User' logged from 192.168.1.100:8 to 192.168.5.4:100 pro:ftp act:remove id:1 url:ossec dat:huzaw e_data:hwazu sta:rejected systemname:system1
'''
        response = send_log(log)
...
'''
    ...
    def test_different_fields_different_protocol_6(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_different_filters[12345]:Test different_protocol 'Srcuser' 'User' logged from 192.168.1.100:8 to 192.168.5.4:20 pro:udp act:remove id:1 url:ossec dat:huzaw e_data:hwazu sta:rejected systemname:system1
'''
        response = send_log(log)
...
'''
    ...
    def test_different_fields_different_action_6(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_different_filters[12345]:Test different_action 'Srcuser' 'User' logged from 192.168.1.100:8 to 192.168.5.4:20 pro:ftp act:update id:1 url:ossec dat:huzaw e_data:hwazu sta:rejected systemname:system1
'''
        response = send_log(log)
...
'''
    ...
    def test_different_fields_different_id_6(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_different_filters[12345]:Test different_id 'Srcuser' 'User' logged from 192.168.1.100:8 to 192.168.5.4:20 pro:ftp act:remove id:2 url:ossec dat:huzaw e_data:hwazu sta:rejected systemname:system1
'''
        response = send_log(log)
...
'''
    ...
    def test_different_fields_different_url_6(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_different_filters[12345]:Test different_url 'Srcuser' 'User' logged from 192.168.1.100:8 to 192.168.5.4:20 pro:ftp act:remove id:1 url:wazuh dat:huzaw e_data:hwazu sta:rejected systemname:system1
'''
        response = send_log(log)
...
'''
    ...
    def test_different_fields_different_data_6(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_different_filters[12345]:Test different_data 'Srcuser' 'User' logged from 192.168.1.100:8 to 192.168.5.4:20 pro:ftp act:remove id:1 url:ossec dat:data1 e_data:hwazu sta:rejected systemname:system1
'''
        response = send_log(log)
...
'''
    ...
    def test_different_fields_different_extra_data_6(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_different_filters[12345]:Test different_extra_data 'Srcuser' 'User' logged from 192.168.1.100:8 to 192.168.5.4:20 pro:ftp act:remove id:1 url:ossec dat:huzaw e_data:edata1 sta:rejected systemname:system1
'''
        response = send_log(log)
...
'''
    ...
    def test_different_fields_different_status_6(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_different_filters[12345]:Test different_status 'Srcuser' 'User' logged from 192.168.1.100:8 to 192.168.5.4:20 pro:ftp act:remove id:1 url:ossec dat:huzaw e_data:hwazu sta:accepted systemname:system1
'''
        response = send_log(log)
...
'''
    ...
    def test_different_fields_different_system_name_6(self) -> None:
        log = r'''
Dec 19 17:20:08 User test_different_filters[12345]:Test different_system_name 'Srcuser' 'User' logged from 192.168.1.100:8 to 192.168.5.4:20 pro:ftp act:remove id:1 url:ossec dat:huzaw e_data:hwazu sta:rejected systemname:system2
'''
        response = send_log(log)
