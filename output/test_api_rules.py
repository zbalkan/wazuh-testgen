    ...
    class TestApiRules(unittest.TestCase):
            ...
            def test_API's_response_code_returned_error_Permission_denied(self) -> None:
            ...
            def test_API's_PUT_method_event(self) -> None:
            ...
            def test_API's_GET_method_event_success(self) -> None:
