...
class TestApiRules(unittest.TestCase):
    ...
    def test_api_bad_request(self) -> None:
        log = r'''
2021/10/05 10:33:18 INFO: testing 172.21.0.1 "GET /agents/upgrade_result" with parameters {"agents_list": "bad_id"} and body {} done in 0.006s: 400
'''
    ...
    def test_api_unauthorized(self) -> None:
        log = r'''
2021/10/05 10:33:18 INFO: testing 172.21.0.1 "GET /agents/upgrade_result" with parameters {"agents_list": "bad_id"} and body {} done in 0.006s: 401
'''
        response = send_log(log)
    ...
    def test_apis_response_code_returned_error_permission_denied(self) -> None:
        log = r'''
2021/10/04 15:23:55 INFO: unknown_user 172.18.0.1 "GET /agents/upgrade_result" with parameters {"agents_list": "bad_id"} and body {} done in 0.001s: 403
'''
        response = send_log(log)
    ...
    def test_resource_not_found(self) -> None:
        log = r'''
2021/10/05 10:33:18 INFO: testing 172.21.0.1 "GET /agents/upgrade_result" with parameters {"agents_list": "bad_id"} and body {} done in 0.006s: 404
'''
        response = send_log(log)
    ...
    def test_invalid_http_method(self) -> None:
        log = r'''
2021/10/05 10:33:18 INFO: testing 172.21.0.1 "GET /agents/upgrade_result" with parameters {"agents_list": "bad_id"} and body {} done in 0.006s: 405
'''
        response = send_log(log)
    ...
    def test_invalid_content_type(self) -> None:
        log = r'''
2021/10/05 10:33:18 INFO: testing 172.21.0.1 "GET /agents/upgrade_result" with parameters {"agents_list": "bad_id"} and body {} done in 0.006s: 406
'''
        response = send_log(log)
    ...
    def test_maximum_request_body_size_exceeded(self) -> None:
        log = r'''
2021/10/05 10:33:18 INFO: testing 172.21.0.1 "GET /agents/upgrade_result" with parameters {"agents_list": "bad_id"} and body {} done in 0.006s: 413
'''
        response = send_log(log)
    ...
    def test_max_number_of_requests_per_minute_reached(self) -> None:
        log = r'''
2021/10/05 10:33:18 INFO: testing 172.21.0.1 "GET /agents/upgrade_result" with parameters {"agents_list": "bad_id"} and body {} done in 0.006s: 429
'''
        response = send_log(log)
    ...
    def test_internal_error(self) -> None:
        log = r'''
2021/10/05 10:33:18 INFO: testing 172.21.0.1 "GET /agents/upgrade_result" with parameters {"agents_list": "bad_id"} and body {} done in 0.006s: 500
'''
        response = send_log(log)
...
'''
    ...
    def test_apis_get_method_event_success(self) -> None:
        log = r'''
2021/10/05 10:33:14 INFO: testing 172.21.0.1 "GET /agents/stats/distinct" with parameters {"fields": "os.name"} and body {} done in 0.009s: 200
'''
        response = send_log(log)
    ...
    def test_api_post_method_event_success(self) -> None:
        log = r'''
2021/10/07 10:46:00 INFO: wazuh-wui 172.16.1.1 "POST /groups" with parameters {} and body {"group_id": "NewGroup_1"} done in 0.009s: 200
'''
        response = send_log(log)
    ...
    def test_api_delete_method_event_success(self) -> None:
        log = r'''
2021/10/07 10:32:33 INFO: unknown_user 172.16.1.1 "DELETE /agents" with parameters {} and body {} done in 0.001s: 200
'''
        response = send_log(log)
...
'''
    ...
    def test_api_info_warning_event(self) -> None:
        log = r'''
2021/10/04 15:23:55 WARNING: something wrong happened
'''
        response = send_log(log)
    ...
    def test_api_info_error_event(self) -> None:
        log = r'''
2021/10/04 15:23:55 ERROR: Something bad happened
'''
        response = send_log(log)
    ...
    def test_api_info_ip_blocked(self) -> None:
        log = r'''
2021/10/04 15:23:55 ERROR: IP blocked due to exceeded number of logins attempts: 172.18.0.1
'''
        response = send_log(log)
    ...
    def test_api_info_critical_event(self) -> None:
        log = r'''
2021/10/05 10:30:21 CRITICAL: Generated private key file in WAZUH_PATH/api/configuration/ssl/server.key
'''
        response = send_log(log)
    ...
    def test_api_authentication_success(self) -> None:
        log = r'''
2021/10/05 10:33:15 INFO: testing 172.21.0.1 "POST /security/user/authenticate" with parameters {} and body {} done in 0.354s: 200
'''
        response = send_log(log)
...
'''
    ...
    def test_api_authentication_failure(self) -> None:
        log = r'''
2021/10/05 10:33:15 INFO: testing 172.21.0.1 "POST /security/user/authenticate" with parameters {} and body {} done in 0.354s: 400
'''
        response = send_log(log)
