...
class TestTestExprNegationGeoipRules(unittest.TestCase):
    ...
    def test_expr_negation_geoip_dstgroip_1(self) -> None:
        log = r'''
May  1 16:17:43 wazuhUsr test_geoip[9024]: connect to 8.8.8.8 from 94.80.188.102
'''
    ...
    def test_expr_negation_geoip_dstgroip_2(self) -> None:
        log = r'''
May  1 16:17:43 wazuhUsr test_geoip[9024]: connect to 194.69.224.10 from 94.80.188.102
'''
        response = send_log(log)
    ...
    def test_expr_negation_geoip_dstgroip_3(self) -> None:
        log = r'''
May  1 16:17:43 wazuhUsr test_geoip[9024]: connect to 200.16.16.1 from 94.80.188.102
'''
        response = send_log(log)
    ...
    def test_expr_negation_geoip_srcgroip_1(self) -> None:
        log = r'''
May  1 16:17:43 wazuhUsr test_geoip[9024]: disconnect to 94.80.188.102 from 8.8.8.8
'''
        response = send_log(log)
    ...
    def test_expr_negation_geoip_srcgroip_2(self) -> None:
        log = r'''
May  1 16:17:43 wazuhUsr test_geoip[9024]: disconnect to 94.80.188.102 from 194.69.224.10
'''
        response = send_log(log)
    ...
    def test_expr_negation_geoip_srcgroip_3(self) -> None:
        log = r'''
May  1 16:17:43 wazuhUsr test_geoip[9024]: disconnect to 94.80.188.102 from 200.16.16.1
'''
        response = send_log(log)
