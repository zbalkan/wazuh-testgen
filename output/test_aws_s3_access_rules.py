...
class TestAws_s3_accessRules(unittest.TestCase):
    ...
    def test_operation_get(self) -> None:
        log = '''{"integration": "aws", "aws": {"log_info": {"aws_account_alias": "", "log_file": "access_logs/2021-04-29-09-41-37-6CFDED3B1BCCDEB1", "s3bucket": "wazuh-aws-wodle"}, "bucket_owner": "3ab1235e25ea9e94ff9b7e4e379ba6b0c872cd36c096e1ac8cce7df433b47101", "bucket": "wazuh-cloudtrail", "time": "29/Apr/2021:08:57:58 +0000", "remote_ip": "213.194.148.169", "requester": "arn:aws:iam::166157441623:user/carlos.ridao", "request_id": "M5XS2MGJ6FEA5VTJ", "operation": "REST.GET.BUCKETVERSIONS", "key": "-", "request_uri": "GET /?versions&max-keys=1&encoding-type=url HTTP/1.1", "http_status": "200", "error_code": "-", "bytes_sent": "839", "object_sent": "-", "total_time": "54", "turn_around_time": "53", "referer": "-", "user_agent": "S3Console/0.4, aws-internal/3 aws-sdk-java/1.11.991 Linux/4.9.230-0.1.ac.224.84.332.metal1.x86_64 OpenJDK_64-Bit_Server_VM/25.282-b08 java/1.8.0_282 vendor/Oracle_Corporation cfg/retry-mode/legacy", "version_id": "-", "host_id": "JyPaquNlVOP38Ap/6E0zqnh5Zj75+9KAv0weFdQChcLd6oaNZZxWyJUPhQgahDu4EHWDy7zQOsA=", "signature_version": "SigV4", "cipher_suite": "ECDHE-RSA-AES128-GCM-SHA256", "authentication_type": "AuthHeader", "host_header": "wazuh-cloudtrail.s3.us-east-1.amazonaws.com", "tls_version": "TLSv1.2", "source": "s3_server_access"}}'''
        response = send_log(log)
    ...
    def test_silence_general_restgetobject(self) -> None:
        log = '''{"integration": "aws", "aws": {"log_info": {"aws_account_alias": "", "log_file": "access_logs/2021-04-29-09-41-37-6CFDED3B1BCCDEB1", "s3bucket": "wazuh-aws-wodle"}, "bucket_owner": "3ab1235e25ea9e94ff9b7e4e379ba6b0c872cd36c096e1ac8cce7df433b47101", "bucket": "wazuh-cloudtrail", "time": "29/Apr/2021:08:57:58 +0000", "remote_ip": "213.194.148.169", "requester": "arn:aws:iam::166157441623:user/carlos.ridao", "request_id": "M5XS2MGJ6FEA5VTJ", "operation": "REST.GET.OBJECT", "key": "-", "request_uri": "GET /?versions&max-keys=1&encoding-type=url HTTP/1.1", "http_status": "200", "error_code": "-", "bytes_sent": "839", "object_sent": "-", "total_time": "54", "turn_around_time": "53", "referer": "-", "user_agent": "S3Console/0.4, aws-internal/3 aws-sdk-java/1.11.991 Linux/4.9.230-0.1.ac.224.84.332.metal1.x86_64 OpenJDK_64-Bit_Server_VM/25.282-b08 java/1.8.0_282 vendor/Oracle_Corporation cfg/retry-mode/legacy", "version_id": "-", "host_id": "JyPaquNlVOP38Ap/6E0zqnh5Zj75+9KAv0weFdQChcLd6oaNZZxWyJUPhQgahDu4EHWDy7zQOsA=", "signature_version": "SigV4", "cipher_suite": "ECDHE-RSA-AES128-GCM-SHA256", "authentication_type": "AuthHeader", "host_header": "wazuh-cloudtrail.s3.us-east-1.amazonaws.com", "tls_version": "TLSv1.2", "source": "s3_server_access"}}'''
        response = send_log(log)
    ...
    def test_operation_put(self) -> None:
        log = '''{"integration": "aws", "aws": {"log_info": {"aws_account_alias": "", "log_file": "access_logs/2021-04-29-09-38-27-8196FC2529DE67C3", "s3bucket": "wazuh-aws-wodle"}, "bucket_owner": "3ab1235e25ea9e94ff9b7e4e379ba6b0c872cd36c096e1ac8cce7df433b47101", "bucket": "wazuh-cloudtrail", "time": "29/Apr/2021:08:52:31 +0000", "remote_ip": "-", "requester": "svc:cloudtrail.amazonaws.com", "request_id": "WF1XB03CFCAN420K", "operation": "REST.PUT.OBJECT", "key": "AWSLogs/166157441623/CloudTrail/us-west-1/2021/04/29/166157441623_CloudTrail_us-west-1_20210429T0840Z_QcTREycd1xiqQru5.json.gz", "request_uri": "PUT /AWSLogs/166157441623/CloudTrail/us-west-1/2021/04/29/166157441623_CloudTrail_us-west-1_20210429T0840Z_QcTREycd1xiqQru5.json.gz HTTP/1.1", "http_status": "200", "error_code": "-", "bytes_sent": "-", "object_sent": "2725", "total_time": "103", "turn_around_time": "15", "referer": "-", "user_agent": "-", "version_id": "-", "host_id": "FFcul1xzEVPZlAQn1tZoJq9SFEwudrfxAGWlYVbgM4OklyDqK8l9PNkSI30q17vwyGMUFQSyDGQ=", "signature_version": "SigV4", "cipher_suite": "ECDHE-RSA-AES128-GCM-SHA256", "authentication_type": "AuthHeader", "host_header": "wazuh-cloudtrail.s3.us-east-1.amazonaws.com", "tls_version": "TLSv1.2", "source": "s3_server_access"}}'''
        response = send_log(log)
    ...
    def test_silence_events_when_s3_puts(self) -> None:
        log = '''{"integration":"aws","aws":{"log_info":{"aws_account_alias":"","log_file":"access_logs/2021-04-29-09-38-27-8196FC2529DE67C3","s3bucket":"wazuh-aws-wodle"},"bucket_owner":"3ab1235e25ea9e94ff9b7e4e379ba6b0c872cd36c096e1ac8cce7df433b47101","bucket":"wazuh-cloudtrail","time":"29/Apr/2021:08:52:31 +0000","remote_ip":"-","requester":"svc:s3.amazonaws.com","request_id":"WF1XB03CFCAN420K","operation":"REST.PUT.OBJECT","key":"AWSLogs/166157441623/CloudTrail/us-west-1/2021/04/29/166157441623_CloudTrail_us-west-1_20210429T0840Z_QcTREycd1xiqQru5.json.gz","request_uri":"PUT /AWSLogs/166157441623/CloudTrail/us-west-1/2021/04/29/166157441623_CloudTrail_us-west-1_20210429T0840Z_QcTREycd1xiqQru5.json.gz HTTP/1.1","http_status":"200","error_code":"-","bytes_sent":"-","object_sent":"2725","total_time":"103","turn_around_time":"15","referer":"-","user_agent":"-","version_id":"-","host_id":"FFcul1xzEVPZlAQn1tZoJq9SFEwudrfxAGWlYVbgM4OklyDqK8l9PNkSI30q17vwyGMUFQSyDGQ=","signature_version":"SigV4","cipher_suite":"ECDHE-RSA-AES128-GCM-SHA256","authentication_type":"AuthHeader","host_header":"wazuh-cloudtrail.s3.us-east-1.amazonaws.com","tls_version":"TLSv1.2","source":"s3_server_access"}}'''
        response = send_log(log)
    ...
    def test_aws_s3_post_operation(self) -> None:
        log = '''{"integration":"aws","aws":{"log_info":{"aws_account_alias":"","log_file":"access_logs/2021-04-29-09-38-27-8196FC2529DE67C3","s3bucket":"wazuh-aws-wodle"},"bucket_owner":"3ab1235e25ea9e94ff9b7e4e379ba6b0c872cd36c096e1ac8cce7df433b47101","bucket":"wazuh-cloudtrail","time":"29/Apr/2021:08:52:31 +0000","remote_ip":"-","requester":"svc:cloudtrail.amazonaws.com","request_id":"WF1XB03CFCAN420K","operation":"REST.POST.OBJECT","key":"AWSLogs/166157441623/CloudTrail/us-west-1/2021/04/29/166157441623_CloudTrail_us-west-1_20210429T0840Z_QcTREycd1xiqQru5.json.gz","request_uri":"PUT /AWSLogs/166157441623/CloudTrail/us-west-1/2021/04/29/166157441623_CloudTrail_us-west-1_20210429T0840Z_QcTREycd1xiqQru5.json.gz HTTP/1.1","http_status":"200","error_code":"-","bytes_sent":"-","object_sent":"2725","total_time":"103","turn_around_time":"15","referer":"-","user_agent":"-","version_id":"-","host_id":"FFcul1xzEVPZlAQn1tZoJq9SFEwudrfxAGWlYVbgM4OklyDqK8l9PNkSI30q17vwyGMUFQSyDGQ=","signature_version":"SigV4","cipher_suite":"ECDHE-RSA-AES128-GCM-SHA256","authentication_type":"AuthHeader","host_header":"wazuh-cloudtrail.s3.us-east-1.amazonaws.com","tls_version":"TLSv1.2","source":"s3_server_access"}}'''
        response = send_log(log)
