...
class TestTestExprNegationRules(unittest.TestCase):
    ...
    def test_expr_negation_action_1(self) -> None:
        log = r'''Dec 19 17:20:08 ubuntu test_expr_negation[12345]:test_action wazuh-agent123@192.168.0.2:31415 HTTPS 192.168.0.1:9264 /status/isbad GET format=json content="{'msg'='helloworld'}" RESULT=success'''
    ...
    def test_expr_negation_action_2(self) -> None:
        log = r'''Dec 19 17:20:08 ubuntu test_expr_negation[12345]:test_action wazuh-agent123@192.168.0.2:31415 HTTPS 192.168.0.1:9264 /status/isbad PUT format=json content="{'msg'='helloworld'}" RESULT=success'''
        response = send_log(log)
    ...
    def test_expr_negation_dstip_1(self) -> None:
        log = r'''Dec 19 17:20:08 ubuntu test_expr_negation[12345]:test_dstip wazuh-agent123@192.168.0.2:31415 HTTPS 172.115.14.241:9264 /status/isbad GET format=json content="{'msg'='helloworld'}" RESULT=success'''
        response = send_log(log)
    ...
    def test_expr_negation_dstip_2(self) -> None:
        log = r'''Dec 19 17:20:08 ubuntu test_expr_negation[12345]:test_dstip wazuh-agent123@192.168.0.2:31415 HTTPS 10.0.0.1:9264 /status/isbad GET format=json content="{'msg'='helloworld'}" RESULT=success'''
        response = send_log(log)
    ...
    def test_expr_negation_extra_data_1(self) -> None:
        log = r'''Dec 19 17:20:08 ubuntu test_expr_negation[12345]:test_extra_data wazuh-agent123@192.168.0.2:31415 HTTPS 192.168.0.1:9264 /status/isbad GET format=json content="{'msg'='helloworld'}" RESULT=success'''
        response = send_log(log)
    ...
    def test_expr_negation_extra_data_2(self) -> None:
        log = r'''Dec 19 17:20:08 ubuntu test_expr_negation[12345]:test_extra_data wazuh-agent123@192.168.0.2:31415 HTTPS 192.168.0.1:9264 /status/isbad GET format=json content="{'msg'='test_msg'}" RESULT=success'''
        response = send_log(log)
    ...
    def test_expr_negation_field_1(self) -> None:
        log = r'''Dec 19 17:20:08 ubuntu test_expr_negation[12345]:test_field wazuh-agent123@192.168.0.2:31415 HTTPS 192.168.0.1:9264 /status/isbad GET format=json content="{'msg'='helloworld'}" RESULT=success'''
        response = send_log(log)
    ...
    def test_expr_negation_field_2(self) -> None:
        log = r'''Dec 19 17:20:08 ubuntu test_expr_negation[12345]:test_field wazuh-agent123@192.168.0.2:31415 HTTPS 192.168.0.1:9264 /status/isbad GET format=raw content="msg=helloworld" RESULT=success'''
        response = send_log(log)
    ...
    def test_expr_negation_hostname_1(self) -> None:
        log = r'''Dec 19 17:20:08 hostname_1 test_expr_negation_predec_fields[123]: test_hostname system_name somedata'''
        response = send_log(log)
    ...
    def test_expr_negation_hostname_2(self) -> None:
        log = r'''Dec 19 17:20:08 hostname_3 test_expr_negation_predec_fields[123]: test_hostname system_name somedata'''
        response = send_log(log)
    ...
    def test_expr_negation_id_1(self) -> None:
        log = r'''Dec 19 17:20:08 ubuntu test_expr_negation[12345]:test_id wazuh-agent0@192.168.0.2:31415 HTTPS 192.168.0.1:9264 /status/isbad GET format=json content="{'msg'='helloworld'}" RESULT=success'''
        response = send_log(log)
    ...
    def test_expr_negation_id_2(self) -> None:
        log = r'''Dec 19 17:20:08 ubuntu test_expr_negation[12345]:test_id wazuh-agent13@192.168.0.2:31415 HTTPS 192.168.0.1:9264 /status/isbad GET format=json content="{'msg'='helloworld'}" RESULT=success'''
        response = send_log(log)
    ...
    def test_expr_negation_location_1(self) -> None:
        log = r'''Dec 19 17:20:08 hostname test_expr_negation_predec_fields[123]: test_location_1 system_name somedata'''
        response = send_log(log)
    ...
    def test_expr_negation_location_2(self) -> None:
        log = r'''Dec 19 17:20:08 hostname test_expr_negation_predec_fields[123]: test_location_2 system_name somedata'''
        response = send_log(log)
    ...
    def test_expr_negation_match_1_1(self) -> None:
        log = r'''Dec 19 17:20:08 ubuntu test_match[12345]: test_match_1'''
        response = send_log(log)
    ...
    def test_expr_negation_match_1_2(self) -> None:
        log = r'''Dec 19 17:20:08 ubuntu test_match[12345]: test_match_2'''
        response = send_log(log)
    ...
    def test_expr_negation_match_2_1(self) -> None:
        log = r'''Dec 19 17:20:08 ubuntu test_match[12345]: test_match_5'''
        response = send_log(log)
    ...
    def test_expr_negation_match_2_2(self) -> None:
        log = r'''Dec 19 17:20:08 ubuntu test_match[12345]: test_match_6'''
        response = send_log(log)
    ...
    def test_expr_negation_program_name_1(self) -> None:
        log = r'''Dec 19 17:20:08 hostname test_program_name_01[123]:'''
        response = send_log(log)
    ...
    def test_expr_negation_program_name_2(self) -> None:
        log = r'''Dec 19 17:20:08 hostname test_program_name_03[123]:'''
        response = send_log(log)
    ...
    def test_expr_negation_protocol_1(self) -> None:
        log = r'''Dec 19 17:20:08 ubuntu test_expr_negation[12345]:test_protocol wazuh-agent123@192.168.0.2:31415 HTTP 192.168.0.1:9264 /status/isbad GET format=json content="{'msg'='helloworld'}" RESULT=success'''
        response = send_log(log)
    ...
    def test_expr_negation_protocol_2(self) -> None:
        log = r'''Dec 19 17:20:08 ubuntu test_expr_negation[12345]:test_protocol wazuh-agent123@192.168.0.2:31415 QUIC 192.168.0.1:9264 /status/isbad GET format=json content="{'msg'='helloworld'}" RESULT=success'''
        response = send_log(log)
    ...
    def test_expr_negation_regex_1_1(self) -> None:
        log = r'''Dec 19 17:20:08 ubuntu test_regex[12345]: regex_id-0'''
        response = send_log(log)
    ...
    def test_expr_negation_regex_1_2(self) -> None:
        log = r'''Dec 19 17:20:08 ubuntu test_regex[12345]: regex_id-9'''
        response = send_log(log)
    ...
    def test_expr_negation_regex_2_1(self) -> None:
        log = r'''Dec 19 17:20:08 ubuntu test_regex[12345]: regex_id'''
        response = send_log(log)
    ...
    def test_expr_negation_srcip_1(self) -> None:
        log = r'''Dec 19 17:20:08 ubuntu test_expr_negation[12345]:test_srcip wazuh-agent123@172.115.14.241:31415 HTTPS 192.168.0.1:9264 /status/isbad GET format=json content="{'msg'='helloworld'}" RESULT=success'''
        response = send_log(log)
    ...
    def test_expr_negation_srcip_2(self) -> None:
        log = r'''Dec 19 17:20:08 ubuntu test_expr_negation[12345]:test_srcip wazuh-agent123@10.0.0.1:31415 HTTPS 192.168.0.1:9264 /status/isbad GET format=json content="{'msg'='helloworld'}" RESULT=success'''
        response = send_log(log)
    ...
    def test_expr_negation_user_1(self) -> None:
        log = r'''Dec 19 17:20:08 ubuntu test_expr_negation[12345]:test_user ltorv-agent123@192.168.0.2:31415 HTTPS 192.168.0.1:9264 /status/isbad GET format=json content="{'msg'='helloworld'}" RESULT=success'''
        response = send_log(log)
    ...
    def test_expr_negation_user_2(self) -> None:
        log = r'''Dec 19 17:20:08 ubuntu test_expr_negation[12345]:test_user rstall-agent123@192.168.0.2:31415 HTTPS 192.168.0.1:9264 /status/isbad GET format=json content="{'msg'='helloworld'}" RESULT=success'''
        response = send_log(log)
    ...
    def test_expr_negation_url_1(self) -> None:
        log = r'''Dec 19 17:20:08 ubuntu test_expr_negation[12345]:test_url wazuh-agent123@192.168.0.2:31415 HTTPS 192.168.0.1:9264 /admin/auth_key GET format=json content="{'msg'='helloworld'}" RESULT=success'''
        response = send_log(log)
    ...
    def test_expr_negation_url_2(self) -> None:
        log = r'''Dec 19 17:20:08 ubuntu test_expr_negation[12345]:test_url wazuh-agent123@192.168.0.2:31415 HTTPS 192.168.0.1:9264 /profiles/info GET format=json content="{'msg'='helloworld'}" RESULT=success'''
        response = send_log(log)
    ...
    def test_expr_negation_srcport_1(self) -> None:
        log = r'''Dec 19 17:20:08 ubuntu test_expr_negation[12345]:test_srcport wazuh-agent123@192.168.0.2:1234 HTTPS 192.168.0.1:9264 /status/isbad GET format=json content="{'msg'='helloworld'}" RESULT=success'''
        response = send_log(log)
    ...
    def test_expr_negation_srcport_2(self) -> None:
        log = r'''Dec 19 17:20:08 ubuntu test_expr_negation[12345]:test_srcport wazuh-agent123@192.168.0.2:31415 HTTPS 192.168.0.1:9264 /status/isbad GET format=json content="{'msg'='helloworld'}" RESULT=success'''
        response = send_log(log)
    ...
    def test_expr_negation_dstport_1(self) -> None:
        log = r'''Dec 19 17:20:08 ubuntu test_expr_negation[12345]:test_dstport wazuh-agent123@192.168.0.2:31415 HTTPS 192.168.0.1:1234 /status/isbad GET format=json content="{'msg'='helloworld'}" RESULT=success'''
        response = send_log(log)
    ...
    def test_expr_negation_dstport_2(self) -> None:
        log = r'''Dec 19 17:20:08 ubuntu test_expr_negation[12345]:test_dstport wazuh-agent123@192.168.0.2:31415 HTTPS 192.168.0.1:31415 /status/isbad GET format=json content="{'msg'='helloworld'}" RESULT=success'''
        response = send_log(log)
    ...
    def test_expr_negation_status_1(self) -> None:
        log = r'''Dec 19 17:20:08 ubuntu test_expr_negation[12345]:test_status wazuh-agent123@192.168.0.2:31415 HTTPS 192.168.0.1:9264 /status/isbad GET format=json content="{'msg'='helloworld'}" RESULT=success'''
        response = send_log(log)
    ...
    def test_expr_negation_status_2(self) -> None:
        log = r'''Dec 19 17:20:08 ubuntu test_expr_negation[12345]:test_status wazuh-agent123@192.168.0.2:31415 HTTPS 192.168.0.1:9264 /status/isbad GET format=json content="{'msg'='helloworld'}" RESULT=unknown'''
        response = send_log(log)
    ...
    def test_expr_negation_system_name_1(self) -> None:
        log = r'''Dec 19 17:20:08 hostname test_expr_negation_predec_fields[123]: test_system_name system_name_1 somedata'''
        response = send_log(log)
    ...
    def test_expr_negation_system_name_2(self) -> None:
        log = r'''Dec 19 17:20:08 hostname test_expr_negation_predec_fields[123]: test_system_name system_name_3 somedata'''
        response = send_log(log)
    ...
    def test_expr_negation_data_1(self) -> None:
        log = r'''Dec 19 17:20:08 hostname test_expr_negation_predec_fields[123]: test_data system_name data_1'''
        response = send_log(log)
    ...
    def test_expr_negation_data_2(self) -> None:
        log = r'''Dec 19 17:20:08 hostname test_expr_negation_predec_fields[123]: test_data system_name data_3'''
        response = send_log(log)
